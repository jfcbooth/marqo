...
if WITH_HTTPD_PACKAGE:
    ...
    BINDIR = '/var/www/marqo/venv/lib/python3.6/site-packages/mod_wsgi_packages/httpd/bin'
    SBINDIR = '/var/www/marqo/venv/lib/python3.6/site-packages/mod_wsgi_packages/httpd/bin'
    LIBEXECDIR = '/var/www/marqo/venv/lib/python3.6/site-packages/mod_wsgi_packages/httpd/modules'
    SHLIBPATH = ''
